...
export default function HeaderNavigationPage(): React.JSX.Element {
	...
	return (
		<div className="w-full h-full">
			<div className="mb-8">
				<h1 className="font-lato not-italic font-semibold text-[24px] leading-[150%] text-[#3A4050] dark:text-gray-100">Header & Navigation</h1>
				<p className="font-lato not-italic font-normal text-[16px] leading-[150%] text-[#6D7280] dark:text-gray-400">Customize how your CRM navigation and layout will appear to users.</p>
			</div>
			...
			<div className="bg-(--accent-white) dark:bg-gray-800 border border-gray-200 dark:border-gray-700 w-full h-full">
				<div className="box-border w-full h-[97px] border-b border-[#E5E7EB] dark:border-gray-700 mb-6 p-6">
					<h2 className="font-inter text-xl font-semibold text-[#050711] dark:text-gray-100 mb-2">Navigation Settings</h2>
					<p className="font-lato text-sm text-gray-600 dark:text-gray-400 mb-6">Configure your CRM's main navigation structure</p>
				</div>
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6">
					...
					<div className="space-y-8">
						...
						<div>
							...
							{/* Menu Style */}
							<div className="mb-6">
								<h3 className="font-inter text-base font-medium text-[#050711] dark:text-gray-100 mb-4">Menu Style</h3>
								<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
									{/* Layout Style Card */}
									<div
										className={`p-4 border-2 cursor-pointer transition-all ${selectedLayout === 'layout'
											? 'border-[#6C8B7D] dark:border-[#6C8B7D] bg-[#6C8B7D]/10 dark:bg-[#6C8B7D]/20'
									...
									>
										<div className="flex flex-col">
											...
											<h4 className="font-inter text-sm font-medium text-[#050711] dark:text-gray-100 mb-1">Layout Style</h4>
											<p className="font-lato text-xs text-gray-600 dark:text-gray-400">Vertical menu on the left</p>
										</div>
									</div>
									...
									>
										<div className="flex flex-col ">
											...
											<h4 className="font-inter text-sm font-medium text-[#050711] dark:text-gray-100 mb-1">Compact</h4>
											<p className="font-lato text-xs text-gray-600 dark:text-gray-400">Collapsed side menu with icons</p>
										</div>
									</div>
								</div>
							</div>
							...
							{/* Theme Colors */}
							<div className="mb-6">
								<h3 className="font-inter text-base font-medium text-[#050711] dark:text-gray-100 mb-4">Theme Colors</h3>
					...
					<div>
						<div className="bg-gray-50 dark:bg-gray-700 p-6">
							<div className="flex items-center gap-2 mb-4">
								<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
									<path d="M8 1L10.5 5.5L15.5 6L12 9.5L13 14.5L8 12L3 14.5L4 9.5L0.5 6L5.5 5.5L8 1Z" fill="#6B7280" className="dark:fill-gray-400" />
								</svg>
								<h3 className="font-inter text-base font-medium text-[#050711] dark:text-gray-100">Theme Preview</h3>
							</div>
							<p className="font-lato text-sm text-gray-600 dark:text-gray-400 mb-4">Your selected colors will be applied to buttons, links, and UI elements throughout the CRM.</p>
						...
						<div className="mt-4">
							<Button
								...
								className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-300 underline p-0 h-auto"
							>
								Reset to Default
							</Button>
						</div>
