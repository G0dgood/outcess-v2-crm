...
import ApproveReactivationModal from '@/components/ui/ApproveReactivationModal';

const PendingReactivationsPage: React.FC = () => {
	...
	const totalItems = reactivationsData?.pagination?.total || 0;
	const totalPages = reactivationsData?.pagination?.totalPages || 1;
...
export default PendingReactivationsPage;
