	...
	return (
		<div className="">
			...
			<div className="bg-white border border-gray-200   p-6 mb-8 ">
				<h2 className="text-xl font-semibold text-gray-900 mb-6">Platform Growth Trend</h2>
				<PlatformGrowthChart />
			</div>

			{/* Registered Businesses Table */}
			<div className="bg-white border border-gray-200  p-6  ">
				<h2 className="text-xl font-semibold text-gray-900 mb-6">Registered Businesses</h2>
