		...
		<div className="bg-page min-h-screen">
			...
			<section className="pt-32 pb-16 px-6 md:px-[180px]">
				<div className="max-w-4xl mx-auto">
					...
					>
						<p className="text-[10px] md:text-[12px] font-medium" style={plusJakartaStyle}>
			...
			<section className="py-16 px-6 md:px-[180px] bg-white">
				<div className="max-w-4xl mx-auto">
					<h2
						className="text-[24px] md:text-[30px] font-bold mb-6 text-[#050711]"
						style={plusJakartaStyle}
					>
			...
			<section className="py-16 px-6 md:px-[180px] bg-white">
				<div className="max-w-6xl mx-auto">
					<h2
						className="text-[24px] md:text-[30px] font-bold mb-3 text-[#050711] text-center"
						style={plusJakartaStyle}
					>
						Our Core Values: What Drives Us
					</h2>
					<p
						className="text-[12px] md:text-[14px] text-[#4A5565] text-center mb-12"
						style={plusJakartaStyle}
					>
