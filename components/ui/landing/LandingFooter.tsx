	...
	return (
		<footer className="border-t border-light bg-surface">
			<div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-12 md:flex-row md:justify-between">
				...
				<div className="grid flex-1 gap-8 text-sm text-secondary sm:grid-cols-3">
			...
			<div className="border-t border-light bg-surface">
				<div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 py-6 text-xs text-tertiary sm:flex-row">
