...
export function EmptyState({
  ...
  const action = onClick && href && linkLabel ? (
    <Button
      ...
      className="mt-4"
    >
      <div className="flex items-center justify-between gap-1 border-b-[1.5px] font-work-sans font-normal text-[12px] leading-5 tracking-[-0.02em]">
        <span>{linkLabel}</span>
        <span>→</span>
      </div>
    </Button>
  ...
  return (
    <section className="flex flex-col items-center justify-center text-center min-h-[50vh] w-full">
      ...
      <p
        className="mt-2 font-sans font-normal text-[10px] md:text-[12px] leading-[24px] text-center tracking-[-0.03em] w-[300px] md:w-[350px] whitespace-normal"
